 ...
 * @package techlon
 */
$dateEnable = techlon_options('techlon_search_show_date',true);
$categoryEnable = techlon_options('techlon_search_show_category',true);
$imageEnable = techlon_options('techlon_search_image',true);
?>
