...
var Merlin = (function($){
    ...
    function window_loaded(){
        ...
        $( document ).on( 'change', '.js-merlin-demo-import-select', function() {
            ...
            var url = $( '.js-merlin-demo-import-select option:selected' ).attr('data-url');
            var name = $( '.js-merlin-demo-import-select option:selected' ).text();
            $('.current-demo').attr( 'href', url );
            $('.current-demo span').html( name );
    ...
    function ActivateLicense() {
        ...
        var redirected = $( '.redirected-licence' );
        ...
        function ajax_callback(r) {
            if (typeof r.success !== "undefined" && r.success) {
                ...
                if ( typeof r.complete !== "undefined" && r.complete && redirected.length ) {

                    setTimeout(function(){
                        $(".merlin__content--license").addClass('vanishout').delay(300).html('<h1 class="vanishin">'+r.title+'</h1><p class="vanishin">'+r.wait+'</p>');
                    },2000);
